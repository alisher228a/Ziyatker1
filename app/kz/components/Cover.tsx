...
const Cover = () => {
  return (
    <section id="about_us" className='font-inter max-container padding-container flex flex-col gap-20 py-32 md:gap-28 lg:py-20 xl:flex-row mt-10 md:mb-10'> {/* Adjusted margin bottom here */}
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2 m-2 mb-0 md:m-10 bg-[#f3fbf7] px-10 py-10 top-[-40px] h-[600px] rounded-5xl'>
        ...
        <p className='regular-16 mt-3 text-gray-30 xl:max-w-[520px]'>Республикалық Жастар Ұйымы, АОО НИШ қолдауымен жұмыс істейді.</p>
        <br />
