    ...
    <section className="font-sans flex-col flex items-center overflow-hidden py-24">
      <div className="max-container px-4 w-full">
        ...
        <div className="w-full text-center">
          <h1 className="text-4xl md:text-5xl font-bold">News feed</h1>
        </div>
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {Array.isArray(newsList) && newsList.length > 0 ? (
            newsList.map((newsItem) => (
              ...
              >
                ...
                <div className="mt-auto">
                  ...
                  <a className="hover:underline" href={`/en/news/${newsItem.id}`}>
                  {newsItem.deadline
                    ? `Deadline: ${new Date(newsItem.deadline).toLocaleDateString('ru-RU')}`
                  ...
                  <div className="flex justify-between items-center p-5 rounded-b-lg border-t">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span className="ml-2">{newsItem.views} views</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <p className="text-center text-gray-500">The news are not available</p>
          )}
        </div>
      </div>
    </section>
