    ...
    <section className="font-sans flex-col flex items-center overflow-hidden py-24">
      <div className="max-container px-4 w-full">
        ...
        <div className="w-full text-center">
          <h1 className="text-4xl md:text-5xl font-bold">Лента новостей</h1>
        </div>
            ...
            newsList.map((newsItem) => (
              ...
              >
                ...
                <div className="mt-auto">
                  {/* Deadline Block */}
                  {newsItem.deadline && (
                    <div className="bg-red-500 text-white text-center py-2 rounded-xl font-semibold">
                  ...
                  <div className="flex justify-between items-center p-5 rounded-b-lg border-t">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span className="ml-2">{newsItem.views} просмотров</span>
                    </div>
                  </div>
                </div>
              </div>
