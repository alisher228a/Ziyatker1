      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 w-full flex flex-col items-center">
          {Array.isArray(projects) && projects.length > 0 ? (
            projects.map((project, index) => (
              ...
              >
                ...
                <div className="flex-grow p-4 md:p-6 flex flex-col justify-center">
                  <h3 className="text-2xl sm:text-3xl lg:text-3xl font-extrabold text-black mb-4">
                    {project.title}
                  </h3>
                  <p className="text-md sm:text-base lg:text-lg text-gray-700 mb-6">
                    {project.desc}
                  </p>
                  <a 
            ...
            <p className="text-white text-lg sm:text-xl">Нету доступных проектов</p>
          )}
        </div>
      </div>
    </section>
